...
INSERT INTO profiles (
    ...
    CASE 
        WHEN $3 IS NOT NULL 
        THEN pgp_sym_encrypt($3, $4)
        ELSE NULL 
    END::text,
    $5,
    CASE 
        WHEN $6 IS NOT NULL 
        THEN pgp_sym_encrypt($6, $4)
        ELSE NULL 
    END::text,
    $7,
    CASE 
        WHEN $8 IS NOT NULL 
        THEN pgp_sym_encrypt($8, $4)
        ELSE NULL 
    END::text,
    $9,
    CASE 
        WHEN $10 IS NOT NULL 
        THEN pgp_sym_encrypt($10, $4)
        ELSE NULL 
    END::text,
    $11,
    CASE 
        WHEN $12 IS NOT NULL 
        THEN pgp_sym_encrypt($12, $4)
        ELSE NULL 
    END::text,
    $13,
    CASE 
        WHEN $14 IS NOT NULL 
        THEN pgp_sym_encrypt($14, $4)
        ELSE NULL 
    END::text,
    $15,
    CASE 
        WHEN $16 IS NOT NULL 
        THEN pgp_sym_encrypt($16, $4)
        ELSE NULL 
    END::text,
    $17,
    CASE 
        WHEN $18 IS NOT NULL 
        THEN pgp_sym_encrypt($18, $4)
        ELSE NULL 
    END::text,
    $19,
    CASE 
        WHEN $20 IS NOT NULL 
        THEN pgp_sym_encrypt($20, $4)
        ELSE NULL 
    END::text
) RETURNING 
    id,
    ...
    CASE 
        ...
        THEN pgp_sym_decrypt(profile_picture_url::bytea, $4)
        ELSE NULL 
    END::text as profile_picture_url,
    is_first_name_public,
    CASE 
        WHEN first_name IS NOT NULL 
        THEN pgp_sym_decrypt(first_name::bytea, $4)
        ELSE NULL 
    END::text as first_name,
    is_last_name_public,
    CASE 
        WHEN last_name IS NOT NULL 
        THEN pgp_sym_decrypt(last_name::bytea, $4)
        ELSE NULL 
    END::text as last_name,
    is_email_public,
    CASE 
        WHEN email IS NOT NULL 
        THEN pgp_sym_decrypt(email::bytea, $4)
        ELSE NULL 
    END::text as email,
    is_bio_public,
    CASE 
        WHEN bio IS NOT NULL 
        THEN pgp_sym_decrypt(bio::bytea, $4)
        ELSE NULL 
    END::text as bio,
    is_phone_number_public,
    CASE 
        WHEN phone_number IS NOT NULL 
        THEN pgp_sym_decrypt(phone_number::bytea, $4)
        ELSE NULL 
    END::text as phone_number,
    is_address_public,
    CASE 
        WHEN address IS NOT NULL 
        THEN pgp_sym_decrypt(address::bytea, $4)
        ELSE NULL 
    END::text as address,
    is_academic_institution_public,
    CASE 
        WHEN academic_institution IS NOT NULL 
        THEN pgp_sym_decrypt(academic_institution::bytea, $4)
        ELSE NULL 
    END::text as academic_institution,
    is_academic_email_public,
    CASE 
        WHEN academic_email IS NOT NULL 
        THEN pgp_sym_decrypt(academic_email::bytea, $4)
        ELSE NULL 
...
SELECT 
    ...
    CASE 
        WHEN profile_picture_url IS NOT NULL 
        THEN pgp_sym_decrypt(profile_picture_url::bytea, $1)
        ELSE NULL 
    END::text as profile_picture_url,
    is_first_name_public,
    CASE 
        WHEN first_name IS NOT NULL 
        THEN pgp_sym_decrypt(first_name::bytea, $1)
        ELSE NULL 
    END::text as first_name,
    is_last_name_public,
    CASE 
        WHEN last_name IS NOT NULL 
        THEN pgp_sym_decrypt(last_name::bytea, $1)
        ELSE NULL 
    END::text as last_name,
    is_email_public,
    CASE 
        WHEN email IS NOT NULL 
        THEN pgp_sym_decrypt(email::bytea, $1)
        ELSE NULL 
    END::text as email,
    is_bio_public,
    CASE 
        WHEN bio IS NOT NULL 
        THEN pgp_sym_decrypt(bio::bytea, $1)
        ELSE NULL 
    END::text as bio,
    is_phone_number_public,
    CASE 
        WHEN phone_number IS NOT NULL 
        THEN pgp_sym_decrypt(phone_number::bytea, $1)
        ELSE NULL 
    END::text as phone_number,
    is_address_public,
    CASE 
        WHEN address IS NOT NULL 
        THEN pgp_sym_decrypt(address::bytea, $1)
        ELSE NULL 
    END::text as address,
    is_academic_institution_public,
    CASE 
        WHEN academic_institution IS NOT NULL 
        THEN pgp_sym_decrypt(academic_institution::bytea, $1)
        ELSE NULL 
    END::text as academic_institution,
    is_academic_email_public,
    CASE 
        WHEN academic_email IS NOT NULL 
        THEN pgp_sym_decrypt(academic_email::bytea, $1)
        ELSE NULL 
    END::text as academic_email,
    created_at,
    updated_at
...
AND pgp_sym_decrypt(email::bytea, $1) = $2
`
...
RETURNING 
    ...
    CASE 
        WHEN profile_picture_url IS NOT NULL 
        THEN pgp_sym_decrypt(profile_picture_url::bytea, $3)
        ELSE NULL 
    END::text as profile_picture_url,
    is_first_name_public,
    CASE 
        WHEN first_name IS NOT NULL 
        THEN pgp_sym_decrypt(first_name::bytea, $3)
        ELSE NULL 
    END::text as first_name,
    is_last_name_public,
    CASE 
        WHEN last_name IS NOT NULL 
        THEN pgp_sym_decrypt(last_name::bytea, $3)
        ELSE NULL 
    END::text as last_name,
    is_email_public,
    CASE 
        WHEN email IS NOT NULL 
        THEN pgp_sym_decrypt(email::bytea, $3)
        ELSE NULL 
    END::text as email,
    is_bio_public,
    CASE 
        WHEN bio IS NOT NULL 
        THEN pgp_sym_decrypt(bio::bytea, $3)
        ELSE NULL 
    END::text as bio,
    is_phone_number_public,
    CASE 
        WHEN phone_number IS NOT NULL 
        THEN pgp_sym_decrypt(phone_number::bytea, $3)
        ELSE NULL 
    END::text as phone_number,
    is_address_public,
    CASE 
        WHEN address IS NOT NULL 
        THEN pgp_sym_decrypt(address::bytea, $3)
        ELSE NULL 
    END::text as address,
    is_academic_institution_public,
    CASE 
        WHEN academic_institution IS NOT NULL 
        THEN pgp_sym_decrypt(academic_institution::bytea, $3)
        ELSE NULL 
    END::text as academic_institution,
    is_academic_email_public,
    CASE 
        WHEN academic_email IS NOT NULL 
        THEN pgp_sym_decrypt(academic_email::bytea, $3)
        ELSE NULL 
    END::text as academic_email,
    created_at,
    updated_at
