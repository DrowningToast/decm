...
type CountCredentialsByVerificationStatusRow struct {
	...
	VerifiedIssuers          int64 `json:"verified_issuers"`
}
...
INSERT INTO authentication_credentials (
    ...
    $8,
    $9
) RETURNING id, solution_status, hashed_password, encrypted_private_key, wallet_address, google_connector_ref, github_connector_ref, is_verified_organizer, is_verified_issuer, is_verified_student, created_at, updated_at
`
...
UPDATE authentication_credentials SET 
    ...
    is_verified_issuer = COALESCE($9, is_verified_issuer),
    updated_at = NOW()
WHERE id = $10 
RETURNING id, solution_status, hashed_password, encrypted_private_key, wallet_address, google_connector_ref, github_connector_ref, is_verified_organizer, is_verified_issuer, is_verified_student, created_at, updated_at
`
