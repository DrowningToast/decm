...
INSERT INTO authentication_credentials (
    ...
    CASE 
        WHEN $5 IS NOT NULL 
        THEN pgp_sym_encrypt($5, $6)
        ELSE NULL 
    END::varchar,
    CASE 
        WHEN $7 IS NOT NULL 
        THEN pgp_sym_encrypt($7, $6)
        ELSE NULL 
    END::varchar,
    $8,
    $9
    ...
    CASE 
        ...
        THEN pgp_sym_decrypt(google_connector_ref::bytea, $6)
        ELSE NULL 
    END::text as google_connector_ref,
    CASE 
        WHEN github_connector_ref IS NOT NULL 
        THEN pgp_sym_decrypt(github_connector_ref::bytea, $6)
        ELSE NULL 
...
SELECT 
    ...
    CASE 
        WHEN google_connector_ref IS NOT NULL 
        THEN pgp_sym_decrypt(google_connector_ref::bytea, $1)
        ELSE NULL 
    END::text as google_connector_ref,
    CASE 
        WHEN github_connector_ref IS NOT NULL 
        THEN pgp_sym_decrypt(github_connector_ref::bytea, $1)
        ELSE NULL 
    END::text as github_connector_ref,
    is_verified_organizer,
    is_verified_student,
...
RETURNING 
    ...
    CASE 
        WHEN google_connector_ref IS NOT NULL 
        THEN pgp_sym_decrypt(google_connector_ref::bytea, $2)
        ELSE NULL 
    END::text as google_connector_ref,
    CASE 
        WHEN github_connector_ref IS NOT NULL 
        THEN pgp_sym_decrypt(github_connector_ref::bytea, $2)
        ELSE NULL 
    END::text as github_connector_ref,
    is_verified_organizer,
    is_verified_student,
...
RETURNING 
    ...
    CASE 
        WHEN google_connector_ref IS NOT NULL 
        THEN pgp_sym_decrypt(google_connector_ref::bytea, $4)
        ELSE NULL 
    END::text as google_connector_ref,
    CASE 
        WHEN github_connector_ref IS NOT NULL 
        THEN pgp_sym_decrypt(github_connector_ref::bytea, $4)
        ELSE NULL 
    END::text as github_connector_ref,
    is_verified_organizer,
    is_verified_student,
...
RETURNING 
    ...
    CASE 
        WHEN google_connector_ref IS NOT NULL 
        THEN pgp_sym_decrypt(google_connector_ref::bytea, $3)
        ELSE NULL 
    END::text as google_connector_ref,
    CASE 
        WHEN github_connector_ref IS NOT NULL 
        THEN pgp_sym_decrypt(github_connector_ref::bytea, $3)
        ELSE NULL 
    END::text as github_connector_ref,
    is_verified_organizer,
    is_verified_student,
