...
export const mockScenarios = {
  ...
  newUser: () => createMockCoreApiClient({
    checkOnboardStatus: vi.fn().mockResolvedValue(mockResponses.checkOnboardStatus)
  }),

  // Existing user with profile
  existingUser: () => createMockCoreApiClient({
    checkOnboardStatus: vi.fn().mockResolvedValue(mockResponses.checkOnboardStatusWithProfile)
  }),

  // Failed registration scenario
  failedRegistration: () => createMockCoreApiClient({
