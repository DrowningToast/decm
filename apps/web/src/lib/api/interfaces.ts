...
export interface ICoreApiV1Client {
  // Auth endpoints
  registerWithGoogleOauth(request: RegisterWithGoogleOauthRequest): Promise<RegisterWithGoogleOauthResponse>
  registerWithWallet(request: RegisterWithWalletRequest): Promise<RegisterWithWalletResponse>
  loginWithGoogleOauth(request: LoginWithGoogleOauthRequest): Promise<LoginWithGoogleOauthResponse>
