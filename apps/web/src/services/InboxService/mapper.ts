...
export const mapInboxMessagesViewModelToInboxMessage = (
    ...
    return {
        ...
        receiverEmail: viewModel.receiver_email,
        receiverWalletAddress: viewModel.receiver_wallet_address,
        senderCredentialEmail: viewModel.sender_credential_email,
        senderCredentialWalletAddress: viewModel.sender_credential_wallet_address,
