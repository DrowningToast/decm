            ...
            <div className="flex md:hidden flex-col gap-1.5 text-[28px]">
                {services.map((service) => (
                    <Link
                        key={service.key}
                        to={service.href}
                        className="h-[34px] text-foreground [text-shadow:rgba(255,255,255,0.3)_0px_0px_4px] underline decoration-solid [text-underline-position:from-font] font-header text-[28px] leading-normal hover:text-primary transition-colors flex items-center gap-2"
                    >
