    ...
    return (
        ...
        >
            ...
            >
                ...
                <header
                    className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between px-3 md:px-6 py-1.5 pointer-events-none z-20 [&>*]:pointer-events-auto transition-all backdrop-blur-[2px] shadow-[0px_4px_16px_0px_rgba(0,0,0,0.1)] overflow-hidden bg-[rgba(217,217,217,0.1)]"
                ...
                <aside
                    ...
                    ref={panelRef}
                    className="staggered-menu-panel absolute top-0 w-[clamp(260px,38vw,420px)] h-full bg-foreground flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] [-webkit-backdrop-filter:blur(12px)] right-0 [.staggered-menu-wrapper[data-position='left']_&]:right-auto [.staggered-menu-wrapper[data-position='left']_&]:left-0"
                    aria-hidden={!open}
                >
