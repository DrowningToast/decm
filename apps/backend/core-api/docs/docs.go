...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/certificate-shares/{certificate_id}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/certificate-shares/{share_id}": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/certificate_share.UpdateCertificateShareBody"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/certificate_share.UpdateCertificateShareResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "certificate_share.UpdateCertificateShareResponse": {
            "type": "object",
            "required": [
                "share"
            ],
