...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/event-registration/fuck-join/{event_id}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Fuck join event payload",
                        "name": "fuckJoinEventPayload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/event_registration.FuckJoinEventPayload"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "event_registration.FuckJoinEventPayload": {
            "type": "object",
            "properties": {
                "academic_email": {
                    "type": "string"
